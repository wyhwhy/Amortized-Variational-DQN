...
class Experience(object):
    ...
    def __init__(self, conf):
        ...
        self.alpha = conf['alpha'] if 'alpha' in conf else 0.5
        ...
        #self.alstep=self.alpha / float(self.total_steps - self.learn_start)
        #self.alpha=self.alpha-self.alstep*float(self.total_steps - self.learn_start)
    ...
    def sample(self,batchsize):
        ...
        print(dist_index)
        print(np.shape(self.distributions))
        '''
        '''
        print(self.record_size)
        print(self.size)
